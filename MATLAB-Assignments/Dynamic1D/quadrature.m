...
%
% Q=quadrature(nint,'TRIANGULAR',2);written by Jack Chessa
...
% Northwestern University
  ...
  if ( strcmp(qt,'GAUSS') == 1 ) 
    ...
    switch ( quadorder ) 
      ...
      case 5
        ...
        r1wt(1) = 0.236726885056189;
        r1wt(2) = 0.236726885056189;
  ...
  elseif ( strcmp(qt,'TRIANGULAR') == 1 ) 
    ...
    if ( sdim == 3 )  %%% TETRAHEDRA
      ...
      if ( quadorder ~= 1 &  quadorder ~= 2 &  quadorder ~= 5 ...
          &  quadorder ~= 7 ) % check for valid quadrature order
        disp('Incorect quadrature order for triangular quadrature');
        quadorder = 1;
      end
